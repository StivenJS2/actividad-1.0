...
require_once "../Modelo/ModuloCliente/ClienteService.php";
...
if(empty($nombre) || empty($apellido) || empty($contrasena) || empty($direccion) || empty($telefono) || empty($correo_electronico)){
    ...
    $cliente= $this->clienteService->obtenerClientes();
